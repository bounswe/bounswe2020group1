...
class ProductDetailsResponse(id:Int, name:String,description:String, photo_url:String, vendor_name:String,category:String, rating:String, stock:Int, price:String,comments:List<String>){
    @SerializedName("id")
    val id : Int = id
    @SerializedName("name")
