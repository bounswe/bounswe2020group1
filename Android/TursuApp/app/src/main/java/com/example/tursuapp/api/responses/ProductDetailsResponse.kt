...
class ProductDetailsResponse(id:Int, name:String,description:String, photo_url:String, vendor_name:String,category:String, rating:String, stock:Int, price:String, brand:String,comments:List<Comments>){
    @SerializedName("id")
    val id : Int = id
    @SerializedName("name")
    ...
    val comments : List<Comments> = comments

}
class Comments(id:Int,customer:String,text:String,rating:Int){
    @SerializedName("id")
    val id : Int = id
