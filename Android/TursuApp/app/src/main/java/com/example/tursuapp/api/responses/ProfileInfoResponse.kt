...
class ProfileInfoResponse(username:String,email:String, first_name:String, last_name:String,money_spent:Int, orders:List<String>, lists:List<String>) {
